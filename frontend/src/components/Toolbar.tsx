...
export function Toolbar({
  ...
  return (
    <header className="toolbar">
      {/* Brand — logo toggles theme, text navigates to / */}
      <div className="toolbar-brand">
        ...
        >
          <LatticeIcon size={16} color="currentColor" />
        </button>
        <button
          className="toolbar-brand-text"
          onClick={() => router.push('/')}
        >
          Lattice
        </button>
      ...
      <div className="toolbar-right">
        ...
        {/* Share — copies URL, shows brief "Copied!" confirmation */}
        <button className="btn btn-primary btn-sm" onClick={handleShareClick}>
          {shareCopied ? (
            <>
